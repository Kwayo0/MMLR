...
func _on_warp_zone_body_entered(_body: Node3D) -> void:
	var five = load("res://scenes/main_sub_gate_5.tscn").instantiate()
	main.add_child(five)
...
func _on_warp_zone_2_body_entered(_body: Node3D) -> void:
	var four = load("res://scenes/main_sub_gate_4.tscn").instantiate()
	main.add_child(four)
...
func _on_warp_zone_3_body_entered(_body: Node3D) -> void:
	var two = load("res://scenes/main_sub_gate_2.tscn").instantiate()
	main.add_child(two)
	two.get_node("Megaman").position = Vector3(2,1,-12.5)
